...
app.Animation = (function () {
	...
	function start() {
		...
		.to(txt2, 1, {x:'-=970', ease: Expo.easeOut}, "+=1")
		...
		.to(txt5, 1, {x:'-=970', ease: Expo.easeOut}, "-=.15")
		.to("#blur5feGaussianBlur", .9, {attr:{stdDeviation:"0.1 0"}, ease:Expo.easeOut}, "-=1")

		.to(txt5, 1, {x:'-=970', ease: Expo.easeIn}, "+=1")
		...
		.to(txt6, 1, {x:'-=970', ease: Expo.easeOut}, "-=.15")
