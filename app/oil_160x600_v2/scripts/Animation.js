...
app.Animation = (function () {
	...
	function start() {
		...
		.to(txt2, 1, {y:'-=40', ease: Expo.easeInOut})
		.to(txt2, 1, {y:'-=40', ease: Expo.easeInOut}, "+=1")
		.set(txt2, {display:"none"})

		.set(txt3, {display:"block"}, "-=1")
		.to(txt3, 1, {y:'-=40', ease: Expo.easeInOut}, "-=1")
		.to(txt3, 1, {y:'-=40', ease: Expo.easeInOut}, "+=1")
