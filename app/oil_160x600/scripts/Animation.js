...
app.Animation = (function () {
	...
	function start() {
		...
		.to(txt2, 1, {x:'-=160', ease: Expo.easeOut}, "+=1")
		...
		.to(txt3, 1, {x:'-=160', ease: Expo.easeOut}, "-=.15")
		...
		.to(txt4, 1, {x:'-=160', ease: Expo.easeOut}, "-=.15")
		...
		.to(txt5, 1, {x:'-=160', ease: Expo.easeOut}, "-=.15")
		...
		.to(txt6, 1, {x:'-=160', ease: Expo.easeOut}, "-=.15")
